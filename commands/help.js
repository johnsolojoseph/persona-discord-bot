module.exports = {
	help: () => {
		return '``` \t Here is a list of commands: \n \
            ...
            p!negotiate: \n \t\t\t\t Negotiate with a person from encounter to add to your list (still in development) \n \
            p!stats: \n \t\t\t\t Show user stats (still in development) \n \
            p!personas: \n \t\t\t\t Show user\'s persona list (still in development) \n \
            p!help: \n \t\t\t\t Reshow this text ```';
	},
};